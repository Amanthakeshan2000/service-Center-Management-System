...
namespace Service_Management_System
{
    public partial class service : UserControl
    {
        ...
        {
            string connectionString = "Data Source=MSI\\SQLEXPRESS;Initial Catalog=Auto_Flash_Database;Integrated Security=True;Encrypt=True;Trust Server Certificate=True"; // Replace with your actual connection string
        ...
        private void pictureBox13_Click(object sender, EventArgs e)
        {
            try
            {
                using (SqlConnection connection = new SqlConnection("Data Source=MSI\\SQLEXPRESS;Initial Catalog=1;Integrated Security=True;"))
                {
                    connection.Open();
        ...
        {
            string connectionString = "Data Source=MSI\\SQLEXPRESS;Initial Catalog=1;Integrated Security=True;"; // Replace with your actual connection string
        ...
        public void getSum()
        {
            string connectionString = "Data Source=MSI\\SQLEXPRESS;Initial Catalog=1;Integrated Security=True;";
